...
class SettingsDialog(wx.Dialog):
    def __init__(
        self, parent: wx.Window, show_hidden_files: bool, confirm_delete: bool, show_file_extensions: bool
    ) -> None:
        super().__init__(parent, title="Settings", size=(380, 220))
        self._result_show_hidden = show_hidden_files
        self._result_confirm_delete = confirm_delete
        self._result_show_file_extensions = show_file_extensions
        ...
        outer.Add(self._confirm_delete_ctrl, 0, wx.LEFT | wx.RIGHT | wx.TOP, 16)

        self._show_file_extensions_ctrl = wx.CheckBox(self, label="Show file extensions")
        self._show_file_extensions_ctrl.SetValue(show_file_extensions)
        outer.Add(self._show_file_extensions_ctrl, 0, wx.ALL, 16)
    ...
    def _on_ok(self, event: wx.CommandEvent) -> None:
        ...
        self._result_show_file_extensions = self._show_file_extensions_ctrl.GetValue()
    ...
    def get_show_file_extensions(self) -> bool:
        return self._result_show_file_extensions
